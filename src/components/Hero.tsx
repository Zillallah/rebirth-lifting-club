...
export function Hero() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[var(--color-canvas)]">
      ...
      {/* Top bar — wordmark left, live clock right */}
      ...
      {/* Bottom — one CTA, one location whisper */}
      <div className="absolute bottom-0 left-0 right-0 px-6 md:px-12 pb-10 md:pb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-6 z-10">
