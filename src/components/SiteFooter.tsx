...
export function SiteFooter() {
  return (
    <footer id="contact" className="relative bg-[var(--color-carbon)] z-90 overflow-hidden pt-24 md:pt-40">
      <div className="relative w-full max-w-[1480px] mx-auto px-6 md:px-12">
        ...
        <RevealGroup stagger={0.15} className="grid md:grid-cols-2 gap-12 md:gap-16 pb-16 md:pb-20 border-b border-[var(--color-steel)]/40">
          <RevealItem>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 py-12 md:py-16 border-b border-[var(--color-steel)]/40">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-12 h-12 flex items-center justify-center border border-[var(--color-steel)]/60 text-[var(--color-off-white)]/70 hover:border-[var(--color-amber)] hover:text-[var(--color-amber)] hover:-translate-y-0.5 transition-all duration-300"
