...
function Review({ quote, name }: ReviewProps) {
  return (
    <div className="bg-[var(--color-canvas)] border border-[var(--color-steel)]/40 p-8 md:p-10 hover:border-[var(--color-amber)]/60 hover:-translate-y-1 transition-all duration-500 flex flex-col h-full">
...
export function Voices() {
  return (
    <section id="voices" className="relative bg-[var(--color-carbon)] z-70 overflow-hidden py-32 md:py-48">
      <div className="relative w-full max-w-[1280px] mx-auto px-6 md:px-12">
        ...
        <RevealGroup stagger={0.12} className="grid md:grid-cols-2 gap-6 md:gap-8 mb-16">
          <RevealItem y={40}>
            <Review
